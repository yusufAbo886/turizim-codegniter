                    ...
                    <table id="dataTable" class="col-md-12 table-bordered table-striped table-condensed cf">
                        <thead class="cf">
                            <tr>
                                ...
                                <th style="width: 20%">En Details</th>
                                <th style="width: 20%">Ar Details</th>
                                <th style="width: 8%">The Latitude</th>
                                <th style="width: 8%">The Longitude</th>
...
<script>
    ...
    $(document).ready(function () {
       ...
       $(".nav>li>a.contactUs").addClass("active");
        ...
        function dtBuilder() {
            var options = {
                ajaxUrl: "/admin/ajax/getContactUs",
                innerFunc: function () {
