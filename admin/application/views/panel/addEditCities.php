...
<div class="card card-custom gutter-b example example-compact">
    ...
    <!--begin::Form-->
    <form action="/panel/ajax/addEditCities" class="form" id="validation" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                <label>the URL:</label>
                <input id="input4" name="url" class="form-control form-control-solid" placeholder="Enter url" required/>
                <span class="form-text text-muted">you need the url</span>
            </div>
    ...
    $(".form").ajaxForm({
        ...
        complete: function (xhr) {
            ...
            if (response == 1) {
                ...
                window.open("/panel/cities/", "_self");
            } else {
