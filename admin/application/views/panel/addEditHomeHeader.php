...
<div class="card card-custom gutter-b example example-compact">
    ...
    <form action="/panel/ajax/addEditHomeHeader" class="form" id="validation" method="post" enctype="multipart/form-data">
        <div class="card-body">
    ...
    $(".form").ajaxForm({
        ...
        complete: function (xhr) {
            ...
            if (response == 1) {
                ...
                window.open("/panel/home_header/", "_self");
            } else {
            ...
            switch ($ctrl.attr("type"))
            {
                ...
                case "checkbox":
                    $ctrl.each(function () {
                        ...
                        // 'theTexten': {
                        //     required: function () {
                        //         CKEDITOR.instances.theTexten.updateElement();
                        //     }
                        // },
                        //     'theTexttr': {
                        //         required: function () {
                        //             CKEDITOR.instances.theTexttr.updateElement();
                        //         }
                        //     },
                        //         'theTextar': {
                        //             required: function () {
                        //                 CKEDITOR.instances.theTextar.updateElement();
                        //             }
                        //     },
                    });
                    break;
