...
<div class="card card-custom gutter-b example example-compact">
    ...
    <!--begin::Form-->
    <form action="/panel/ajax/addEditOpinion" class="form" id="validation" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input  class="form-control form-control-solid" id="input2" name="theName" placeholder="Enter name" required />
                <span class="form-text text-muted">Please enter your full Name</span>
            </div>
            <div class="form-group">
                <label>the Icone:</label>
                <input  class="form-control form-control-solid" id="input2" name="theIcone" placeholder="Enter the Icone" required />
                <span class="form-text text-muted">Please enter your full Icone</span>
            </div>
    ...
    $(".form").ajaxForm({
        ...
        complete: function (xhr) {
            ...
            if (response == 1) {
                ...
                window.open("/panel/opinion/", "_self");
            } else {
