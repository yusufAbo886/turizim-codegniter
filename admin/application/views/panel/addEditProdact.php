...
<div class="card card-custom gutter-b example example-compact">
    ...
    <!--begin::Form-->
    <form action="/panel/ajax/addEditProdact" class="form" id="validation" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea id="theTexten"   rows="7"name="theText" class="form-control" required></textarea>
            </div>

<!--            <div class="form-group">-->
<!--                <label>The Alt:</label>-->
<!--                <input  class="form-control form-control-solid" id="input2" name="alt" placeholder="Enter alt" required />-->
<!--                <span class="form-text text-muted">Please enter your full alt</span>-->
<!--            </div>-->
            <div class="form-group">
                <label>the Type:</label>
                <input  class="form-control form-control-solid" id="input2" name="theType" placeholder="Enter the Type" required />
                <span class="form-text text-muted">Please enter your full Type</span>
            </div>
            <div class="form-group">
                <label>Phone:</label>
                <input  class="form-control form-control-solid" id="input2" name="theBath" placeholder="Phone" required />
                <span class="form-text text-muted">Please enter your full Type</span>
            </div>
            <div class="form-group">
                <label>the Room:</label>
                <input  class="form-control form-control-solid" id="input2" name="theRoom" placeholder="Enter the Room" required />
                <span class="form-text text-muted">Please enter your full  Room</span>
            </div>
            <div class="form-group">
                <label>the Location:</label>
                <input  class="form-control form-control-solid" id="input2" name="theLocation" placeholder="Enter the Location" required />
                <span class="form-text text-muted">Please enter your full Location</span>
            </div>
            <div class="form-group">
                <label>the Price:</label>
                <input  class="form-control form-control-solid" id="input2" type="number" name="thePrice" placeholder="Enter the Price" required />
                <span class="form-text text-muted">Please enter your full number</span>
            </div>

            <div class="form-group">
                <label>the owner of house :</label>
                <input  class="form-control form-control-solid"  type="text" id="input2"  name="theNameHome" placeholder="Enter the owner of house" required />
                <span class="form-text text-muted">Please enter your full the owner of house</span>
            </div>

            <div class="form-group">
                <label>the Link:</label>
                <input  class="form-control form-control-solid"  id="input2"  name="url" placeholder="Enter urlr" required />
    ...
    $(".form").ajaxForm({
        ...
        complete: function (xhr) {
            ...
            if (response == 1) {
                ...
                window.open("/panel/prodact/", "_self");
            } else {
