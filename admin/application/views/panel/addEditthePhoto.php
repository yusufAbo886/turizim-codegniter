...
<div class="card card-custom gutter-b example example-compact">
    ...
    <!--begin::Form-->
    <form action="/panel/ajax/addEditPhoto" class="form" id="validation" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <select id="category_id" name="category_id" class="form-control" >
                ...
                <?php foreach ($prodact as  $value){   ?>
                    ...
                    <option value="<?=$value->id?>"><?= $value->theTitle ?></option>
