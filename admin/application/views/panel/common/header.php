...
<head><base href="">
    ...
    <title>Hurenkangoedkoper l Admin</title>
    ...
    <link href="/public2/assets/plugins/custom/prismjs/prismjs.bundle.css" rel="stylesheet" type="text/css" />


    <!--begin::Page Vendors Styles(used by this page)-->
    <link href="/public2/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    <!--end::Page Vendors Styles-->


    <link href="/public2/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />

    <!--end::Global Theme Styles-->

    <!--begin::Layout Themes(used by all pages)-->

    <link href="/public2/assets/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />

    <link href="/public2/assets/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />

    <link href="/public2/assets/css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />

    <link href="/public2/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    ...
    <a href="/">
        ...
        <img alt="Logo"style="width: 150px;height: 20px" src="/public4/images/logo_white_large.png" />
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            ...
                            <a href="/panel/dashbord" class="menu-link">
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text" style=" font-size: 15px ;color:white" >CMS</span>
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/kullanci" class="menu-link">
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text" style="font-size: 15px ;color:white" > Pages</span>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span style="font-size: 14px ;" class="menu-text">Home page</span>
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    ...
                                                    <a href="/panel/home_header" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Homepage Background</span>
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    ...
                                                    <a href="/panel/market" class="menu-link">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    ...
                                                    <a href="/panel/opinion" class="menu-link">
                                                        ...
                                                        <span class="menu-text">customer comments</span>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span style="font-size: 14px ;"class="menu-text">Contact us</span>
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                ...
                                                <!--																<li class="menu-item" aria-haspopup="true">-->
                                                <!---->
                                                <!--																	<a href="/panel/map" class="menu-link">-->
                                                <!---->
                                                <!--																		<i class="menu-bullet menu-bullet-dot">-->
                                                <!---->
                                                <!--																			<span></span>-->
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/cities" class="menu-link">
                                            ...
                                            <span style="font-size: 14px ;" class="menu-text">Cities</span>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span style="font-size: 14px ;" class="menu-text">project</span>
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                ...
                                                <!--																	<li class="menu-item" aria-haspopup="true">-->
                                                <!---->
                                                <!--																		<a href="/panel/projectheader" class="menu-link">-->
                                                <!---->
                                                <!--																			<i class="menu-bullet menu-bullet-dot">-->
                                                <!---->
                                                <!--																				<span></span>-->
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    ...
                                                    <a href="/panel/prodact" class="menu-link">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    ...
                                                    <a href="/panel/photo" class="menu-link">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    ...
                                                    <a href="/panel/prodactUser" class="menu-link">
                                                        ...
                                                        <span class="menu-text">user  properties</span>
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            ...
                            <a href="/panel/seo" class="menu-link">
                                ...
                                <span style="font-size: 15px ;color:white" class="menu-text">SEO</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span style="font-size: 15px ;color:white" class="menu-text">Icons</span>
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/flaticon" class="menu-link">
                                            ...
                                            <span style="font-size: 14px ;" class="menu-text">Flaticon</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/fontawesome5" class="menu-link">
                                            ...
                                            <span style="font-size: 14px ;"  class="menu-text">Fontawesome 5</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/lineawesome" class="menu-link">
                                            ...
                                            <span  style="font-size: 14px ;" class="menu-text">Lineawesome</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/socicons" class="menu-link">
                                            ...
                                            <span style="font-size: 14px ;" class="menu-text">Socicons</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span style="font-size: 15px ;color:white" class="menu-text">Footer</span>
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/footer1" class="menu-link">
                                            ...
                                            <span style="font-size: 14px;"class="menu-text">First Section</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/footer2" class="menu-link">
                                            ...
                                            <span style="font-size: 14px;" class="menu-text">Second Section</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/footer3" class="menu-link">
                                            ...
                                            <span  style="font-size: 14px;"class="menu-text">Third Section</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/footer4" class="menu-link">
                                            ...
                                            <span style="font-size: 14px;" class="menu-text">Foth Section</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span style="font-size: 15px ;color:white" class="menu-text"> The Menu</span>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-parent" aria-haspopup="true">
														...
														<span class="menu-link">
															...
															<span class="menu-text">The Menu</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <a href="/panel/menuLink" class="menu-link">
                                            ...
                                            <span style="font-size: 14px;"  class="menu-text">Menu link</span>
                        ...
                        <!--											<li class="menu-item" aria-haspopup="true">-->
                        <!---->
                        <!--												<a href="/panel/addpages" class="menu-link">-->
                        <!---->
                        <!--													<i class="menu-bullet menu-bullet-dot">-->
                        <!---->
                        <!--														<span></span>-->
                ...
                <div class="topbar">
                    ...
                    <div class="topbar-item" style="margin-left:90%">
                        ...
                        <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2">
                            ...
                            <span style="padding-left: 20px;" class="symbol symbol-lg-35 symbol-25 symbol-light-success">

    											<span style="padding-left: 30px;padding-right: 30px;" class="symbol-label font-size-h5 font-weight-bold">Akın</span>
