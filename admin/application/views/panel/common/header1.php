...
<head>
    ...
    <link rel="shortcut icon" href="/public2/assets/media/logos/favicon.ico" />
                ...
                <div class="login-wrap">
                    <ul class="d-flex">
                        ...
                        <?php  if (isset($this->session->name)){?>
                            ...
                            <li><a href="/panel/logout1/"><i style="font-size: 20px" class="la la-sign-in-alt"></i> logout</a></li>
