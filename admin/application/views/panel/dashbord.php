                        ...
                        <div class="card-spacer mt-n25">
                            ...
                            <div class="row m-0">
                                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                    ...
                                    <a href="#"  style="float: left;"class="text-warning font-weight-bold font-size-h6">Weekly Brokerage</a>
                                    <?php
                                    if (isset($order)){
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="font-weight-bolder text-dark">Incoming Properties</span>
                            <?php
                            if (isset($notactive)){
                                foreach ($notactive as $ctv){

                                    ?>
                                    <span class="text-muted mt-3 font-weight-bold font-size-sm"><?= $ctv->ctv ?> Properties</span>
                    ...
                    <?php if (isset($prodactss)){
                        foreach ($prodactss as $value){?>
                            <div class="card">
                                ...
                                <div class="card-body post_list" >
                                    <h5 class="card-title">new Property</h5>
                                    <p class="card-text"><?= $value->theNameHome ?> wants to  publish a her properity </p>
                                    <form   action="/panel/details" class="form" id="validation" method="post" enctype="multipart/form-data">

                                        <div class="form-group">
                                            <input  type="hidden" class="form-control form-control-solid" value="<?= $value->id?>" name="id"/>
                                        </div>

                                        <button style="float: right" type="submit" class="btn btn-success">details</button>
                                    </form>
...
<script>
    $(document).ready(function(){
        ...
        // $(".post_list").on("click",".see",function(){
        //     var data_id = $(this).attr("data-id");
        //     $.get("/panel/getDetails", {
        //         post_id: data_id,
        //     }
        //
        //     ,function(srp){
