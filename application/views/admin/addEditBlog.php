...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="/admin/ajax/addEditBlog" class="form" id="validation" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        if ($thePhoto != NULL) {
                            ?>
                            <h2>Current Photo</h2>
                            <img src="/public/uploads/php/files/blog/<?= $thePhoto ?>">
                            <?php
                        }
                        ?>
                    </div>
                ...
                <script>
                    $(document).ready(function () {
                        $(function () {
                            'use strict';
                            $('#progress').hide();
                            var url = "/public/uploads/php/?pageType=blog";
                            $('#fileupload').fileupload({
                                ...
                                dataType: 'json',
                                    ...
                                    $.each(data.result.files, function (index, file) {
                                        ...
                                        $("#files").append("<div class='photoPreview'><img src='/public/uploads/php/files/blog/" + file.name + "' /></div>");
