...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="/admin/ajax/addEditCategories2" class="form" id="validation" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <span class="btn btn-success fileinput-button">
                            ...
                            <span>Select photo...(W:400px - H:280px)</span>
                        ...
                        if ($thePhoto != NULL) {
                            ?>
                            <h2>Current Photo</h2>
                            <img src="/public/uploads/php/files/categories/<?= $thePhoto ?>">
                            <?php
                        }
                        ?>
                    </div>
                ...
                <script>
                    $(document).ready(function () {
                        $(function () {
                            'use strict';
                            $('#progress').hide();
                            var url = "/public/uploads/php/?pageType=categories";
                            $('#fileupload').fileupload({
                                ...
                                dataType: 'json',
                                    ...
                                    $.each(data.result.files, function (index, file) {
                                        ...
                                        $("#files").append("<div class='photoPreview'><img src='/public/uploads/php/files/categories/" + file.name + "' /></div>");
...
<script>
     ...
     $(".nav>li>a.realCategories").addClass("active");
                    ...
                    $(".form").ajaxForm({
                        ...
                        complete: function (xhr) {
                            ...
                            if (response == 1) {
                                ...
                                window.open("/admin/real_categories/", "_self");
                            } else {
