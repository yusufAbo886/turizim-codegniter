...
<!--    <div class="col-md-6" dir="rtl" style="text-align: right;"><?= $pageTitle ?></div>-->
        <form action="/admin/ajax/addEditPlans2" class="form" id="validation" method="post" enctype="multipart/form-data">
        <div class="col-md-12">
            <div class="col-md-4">
            <input type="hidden" value="<?= $id ?>" name="id" />
                ...
                <div class="form-group">
                    <h3>The Language</h3>
                    <input class="form-control" type="text" value="<?=$theLang?>" disabled="disabled" />
                    ...
                    $(".form").ajaxForm({
                        ...
                        complete: function (xhr) {
                            ...
                            if (response == 1) {
                                ...
                                window.open("/admin/plans2/<?=$categoryId?>", "_self");
                            } else {
