...
<section class="mainPage">
    <h1 class="textMain">
        <?= $this->lang->line("realServices") ?>
    </h1>

    <div class="addingBar addBtn">
        <div class="btn-group" role="group" aria-label="...">
            <a href="/admin/add_edit_categories2/" class="btn btn-primary right">
            ...
            <div class="row">
                <div id="no-more-tables">
                    ...
                    <table id="dataTable" class="col-md-12 table-bordered table-striped table-condensed cf">
                        <thead class="cf">
                            <tr>
                                <th style="width:25%">The Photo</th>
                                <th style="width:12%">The Language</th>
                                <th>The Title</th>
                                <th>Program's Plans</th>
<!--                                <th>Export Excel</th>-->
...
<script>
    ...
    $(document).ready(function () {
        ...
        function dtBuilder() {
            var options = {
                ajaxUrl: "/admin/ajax/getCategories2",
                innerFunc: function () {
                    $(".deleteButton").click(function () {
                        mText = "Are you sure you want to delete this category!! ?";
                        mTitle = "Delete";
                        mCancelLabel = "Cancel";
                        mOkLabel = "Delete";
