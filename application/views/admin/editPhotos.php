...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="/admin/ajax/editPhotos" class="form" id="validation" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <span class="btn btn-success fileinput-button">
                            ...
                            <span>Select photo...(W:1920px - H:960px)</span>
                        ...
                        if ($thePhoto != NULL) {
                            ?>
                            <h2>Current Photo</h2>
                            <img src="/public/uploads/php/files/photos/thumbnail/<?= $thePhoto ?>">
                            <?php
                        }
                        ?>
                    </div>
                ...
                <script>
                    $(document).ready(function () {
                        $(function () {
                            'use strict';
                            $('#progress').hide();
                            var url = "/public/uploads/php/?pageType=photos";
                            $('#fileupload').fileupload({
                                ...
                                dataType: 'json',
                                    ...
                                    $.each(data.result.files, function (index, file) {
                                        ...
                                        $("#files").append("<div class='photoPreview'><img src='/public/uploads/php/files/photos/thumbnail/" + file.name + "' /></div>");
...
<script>
     ...
     $(".nav>li>a.photos").addClass("active");
                    ...
                    $(".form").ajaxForm({
                        ...
                        complete: function (xhr) {
                            ...
                            if (response == 1) {
                                ...
                                window.open("/admin/photos/", "_self");
                            } else {
