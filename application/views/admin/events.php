...
<section class="mainPage">
    ...
    <div class="addingBar addBtn">
        <div class="btn-group" role="group" aria-label="...">
            <a href="/admin/add_edit_events/<?=$planId?>" class="btn btn-primary right">
            ...
            <div class="row">
                <div id="no-more-tables">
                    ...
                    <table id="dataTable" class="col-md-12 table-bordered table-striped table-condensed cf">
                        <thead class="cf">
                            <tr>
                                <th style="width:15%">Event Code</th>
                                <th> OPen Date</th>
                                <th> Close Date</th>
                                <th> Days Number</th>
                                <th> The Place</th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        function dtBuilder() {
            var options = {
                ajaxUrl: "/admin/ajax/getEvents/<?=$planId?>",
                innerFunc: function () {
                    $(".deleteButton").click(function () {
                        mText = "Are you sure you want to delete this event!! ?";
                        mTitle = "Delete";
                        mCancelLabel = "Cancel";
                        mOkLabel = "Delete";
                    ...
                    $(".publishButton2").click(function () {
                        mText = "Are you sure you want to Cancel this Event !! ?";
                        mTitle = "Cancel This Event";
                        mCancelLabel = "Cancel";
                        mOkLabel = "Yes";
                        modalConfirm($(this), mText, mTitle, mCancelLabel, mOkLabel, function () {
                            $(".paginate_button.active").trigger("click");
                    ...
                    $(".publishButton").click(function () {
                        mText = "Are you sure you want to Activr this Event !! ?";
                        mTitle = "Active This Event";
                        mCancelLabel = "Cancel";
                        mOkLabel = "Yes";
                        modalConfirm($(this), mText, mTitle, mCancelLabel, mOkLabel, function () {
                            $(".paginate_button.active").trigger("click");
