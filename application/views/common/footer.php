...
<footer class="first-footer">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul style="border: none;" class="netsocials">
                        <?php foreach ($footer33 as $value ){?>
                            ...
                            <li ><a href="<?= $value->url ?>"><i style="border: none !important;"class="fa <?= $value->icon ?>" aria-hidden="true"></i></a></li>
                        <?php }?>
                    </ul>
                </div>
            </div>
    ...
    <div class="second-footer">
        <div class="container">
            ...
            <p> Developed  <i class="fa fa-heart" aria-hidden="true"></i> by cross4solution.com</p>
        </div>
    </div>
</footer>
...
<!--<script async-->
<!--        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAC6Y6emK6EqQrp2pfgAdt7BdRxTN0eIL4=geometry,places&callback=initMap">-->
<!--</script>-->
<!--<script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAC6Y6emK6EqQrp2pfgAdt7BdRxTN0eIL4"></script>-->
...
<script src="/public1/lib/ckeditor/ckeditor.js" type="text/javascript"></script>
...
<script>
    $(".lang").on("change", function(){
        $.post( "/site/ajax/changeLanguage", { lang: $(this).val() }, function( data ) {
            if(data == 1){
                location.reload();
            }
        });
