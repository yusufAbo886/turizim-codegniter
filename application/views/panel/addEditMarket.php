...
<div class="card card-custom gutter-b example example-compact">
    ...
    <!--begin::Form-->
    <form action="/panel/ajax/addEditMarket" class="form" id="validation" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea id="theText" name="theText" class="form-control" rows="7"required></textarea>
            </div>
    ...
    $(".form").ajaxForm({
        ...
        complete: function (xhr) {
            ...
            if (response == 1) {
                ...
                window.open("/panel/market/", "_self");
            } else {
