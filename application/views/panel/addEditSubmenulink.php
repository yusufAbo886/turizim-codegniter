            ...
            <!--begin::Card-->
                                ...
                                <div class="card card-custom gutter-b example example-compact">
                                  ...
                                  <form action="/panel/ajax/addEditSubmenulink" class="form" id="validation" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <label for="pet-select">Choose a Category:</label>
                                       ...
                                       <div class="form-group">
                                         ...
                                         <input  class="form-control form-control-solid" id="input2" name="theNameen" placeholder="Enter title" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control form-control-solid" id="input2" name="theNametr" placeholder="Enter title" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control form-control-solid" id="input2" name="theNamear" placeholder="Enter title" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control form-control-solid" id="input2" name="url" placeholder="Enter url" />
                                        ...
                                        <input  class="form-control form-control-solid" id="input2" name="theTitleen" placeholder="Enter title" />
                                      ...
                                      <div class="form-group">
                                                ...
                                                <textarea id="theTexten" name="theTexten" class="form-control"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                      ...
                                                      <textarea id="theTexttr" name="theTexttr" class="form-control"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="theTextar" name="theTextar" class="form-control"></textarea>
                ...
                $(".form").ajaxForm({
                    ...
                    complete: function (xhr) {
                        ...
                        if (response == 1) {
                            ...
                            window.open("/panel/submenulink/", "_self");
                        } else {
